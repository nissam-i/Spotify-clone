        ...
        <>
            ...
            <div className='mt-10 flex gap-8 flex-col md:flex-row md:items-end'>
                ...
                <div className='flex flex-col'>
                    ...
                    <div className='mt-1'>
                        <p className='text-white flex items-center gap-2 text-[15px]'>
                            <img className='inline-block w-5 rounded-full' src="https://placehold.co/50x50/1DB954/FFFFFF?text=S" alt="" />
                            <b>Spotify</b>
                            • 1,323,154 likes
                            • <b>50 songs,</b>
                            about 2 hr 30 min
